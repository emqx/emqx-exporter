...
The messages input/output per second.
...
### Erlang VM Process
The process count of Erlang VM 

### Erlang VM Memory Used
The memory usage of Erlang VM

### Mnesia(built-in database) Memory Usage
It represents the memory usage of Mnesia database in EMQX 5.