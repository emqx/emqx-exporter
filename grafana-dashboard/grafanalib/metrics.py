...
subcharts = {
    "rule-engine-rate": "rule-engine-rate",
    "rule-engine-count": "rule-engine-count",
    "messages": "messages",
...
metrics = {
    ...
    "rule_engine_last_5m_exec_rate": {
        ...
        "subchart_links": (subcharts["rule-engine-rate"], ["subchart_rule_engine_last_5m_exec_rate"]),
        "targets": [
            {
                "legendFormat": "{{ rule }}",
    ...
    "rule_engine_current_exec_rate": {
        ...
        "subchart_links": (subcharts["rule-engine-rate"], ["subchart_rule_engine_current_exec_rate"]),
        "targets": [
            {
                "legendFormat": "{{ rule }}",
    ...
    "rule_engine_exec_success": {
        ...
        "subchart_links": (subcharts["rule-engine-count"], ["subchart_rule_engine_exec_success"]),
        "targets": [
            {
                "legendFormat": "{{rule}}",
    ...
    "rule_engine_action_success": {
        ...
        "subchart_links": (subcharts["rule-engine-count"], ["subchart_rule_engine_action_success"]),
        "targets": [
            {
                "legendFormat": "{{rule}}",
    ...
    "rule_engine_action_failure": {
        ...
        "subchart_links": (subcharts["rule-engine-count"], ["subchart_rule_engine_action_failure"]),
        "targets": [
            {
                "legendFormat": "{{rule}}",
    ...
    "client_connection_events": {
        ...
        "subchart_links": (subcharts["client-events"], ["subchart_client_connection_events", "subchart_client_disconnection_events"]),
        "targets": [
            {
                "legendFormat": "Connections",
    ...
    "client_sub_events": {
        ...
        "subchart_links": (subcharts["client-events"], ["subchart_client_sub_events", "subchart_client_unsub_events"]),
        "targets": [
            {
    ...
    "client_connect_auth_events": {
        ...
        "subchart_links": (subcharts["client-events"], ["subchart_client_connect_auth_events"]),
        "targets": [
            {
    ...
    "client_acl_auth_events_v4": {
        ...
        "subchart_links": (subcharts["client-events"], ["subchart_client_acl_auth_events_v4"]),
        "targets": [
            {
    ...
    "client_acl_auth_events_v5": {
        "title": "Client ACL Auth Events",
        "subchart_links": (subcharts["client-events"], ["subchart_client_acl_auth_events_v5"]),
        "targets": [
            {
                "legendFormat": "ACL Auth",
    ...
    "messages_count": {
        ...
        "subchart_links": (subcharts["messages"], ["subchart_messages_received_rate", "subchart_messages_sent_rate", "subchart_messages_dropped_rate"]),
        "targets": [
            {
    ...
    "authenticate_count": {
        ...
        "subchart_links": (subcharts["authentication"], ["subchart_authenticate_count"]),
        "targets": [
            {
    ...
    "authenticate_current_exec_rate": {
        ...
        "subchart_links": (subcharts["authentication"], ["subchart_authenticate_current_exec_rate"]),
        "targets": [
            {
    ...
    "authenticate_last_5m_exec_rate": {
        ...
        "subchart_links": (subcharts["authentication"], ["subchart_authenticate_last_5m_exec_rate"]),
        "targets": [
            {
                "legendFormat": "{{resource}}",
    ...
    "authorize_count": {
        ...
        "subchart_links": (subcharts["authorization"], ["subchart_authorize_count"]),
        "targets": [
            {
    ...
    "authorize_current_exec_rate": {
        ...
        "subchart_links": (subcharts["authorization"], ["subchart_authorize_current_exec_rate"]),
        "targets": [
            {
                "legendFormat": "{{resource}}",
    ...
    "authorize_last_5m_exec_rate": {
        ...
        "subchart_links": (subcharts["authorization"], ["subchart_authorize_last_5m_exec_rate"]),
        "targets": [
            {
                "legendFormat": "{{resource}}",
    ...
    # Messages Subchart
    "subchart_messages_subchart_row": {
    ...
    "subchart_rule_engine_count_row": {
        "title": "Rule Engine Count Row",
        "gridPos":  {
            "h": 1,
            "w": 24,
            "x": 0,
